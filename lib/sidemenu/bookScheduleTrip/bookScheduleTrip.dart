...
class BookScheduleTrip extends StatefulWidget {
  ...
  const BookScheduleTrip({Key? key, this.toAddress, this.fromAddress}) : super(key: key);

  @override
  State<BookScheduleTrip> createState() =>
      BookScheduleTripState();
}
        ...
        body: Stack(alignment: Alignment.centerRight, children: <Widget>[
          ...
          Column(children: [
            ...
            Container(
              ...
              FromToWidget(
                fromAddress: widget.fromAddress,
                toAddress: widget.toAddress,tripType: BookingTiming.later,),
              CarCategoriesWidget(
                fromAddress: widget.fromAddress,
                toAddress: widget.toAddress,
              ),
